  ...
  return (
    <section id="intro">
      <div className="left-intro">
        ...
        <Link to='https://www.linkedin.com/in/amikhodabande' target='_blank'><button className="introHireMe"><img src={hireImg} alt="hire" className="introBtnImg" />Hire Me</button></Link>
      </div>
